...
class FedRepStrategy():
    ...
    def tell_clients_calculate_personal_paras(self,server_round,clients_proxy):
        print("-"*10+"\033[1;33m FedRep:tell_clients_calculate_personal_paras \033[0m"+"-"*10)
        #init weight
    ...
    def tell_clients_calculate_avg_paras(self,server_round,clients_proxy):
        print("-"*10+"\033[1;33m FedRep:tell_clients_calculate_avg_paras \033[0m"+"-"*10)
        #init weight
        sp=myfn.SPath(server_round-1,None)
        for client_name in clients_proxy:
    ...
    def tell_client_caculate_eval(self,server_round,clients_proxy):
        print("-"*10+"\033[1;33m FedRep:tell_client_caculate_eval \033[0m"+"-"*10)
        sp=myfn.SPath(server_round,None)
        for client_name in clients_proxy:
            #send gradients zip
            sp.name=client_name
